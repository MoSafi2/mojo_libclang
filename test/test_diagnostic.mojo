...
comptime INVALID_PATH: String = "test/api_test_invalid.c"
...
def test_diagnostic_location() raises:
    ...
    _check(Int(loc.line()) >= 1, "diagnostic location should have positive line")
...
def test_diagnostic_format() raises:
    ...
    _check(formatted.byte_length() > 0, "formatted diagnostic should not be empty")
